...
#ifndef XDPD_FSCALE_L2SW_CONFIG_H
#define XDPD_FSCALE_L2SW_CONFIG_H
...
*
* @brief Configuration file for the xDPd Fscale L2switch driver.
* 
*/
...
#endif //XDPD_FSCALE_L2SW_CONFIG_H
